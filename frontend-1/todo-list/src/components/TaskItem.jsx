...
export default function ({ task, done, onComplete, onRemove }) {
  const defaultClasses =
    "bg-sky-100 rounded flex justify-between items-center gap-2 p-3 group w-2/3 hover:cursor-pointer hover:bg-slate-100 transition text-blue-500";
  const doneClasses =
    "flex ease-in duration-700 justify-between items-center p-3 gap-2 rounded bg-blue-500 text-white group w-2/3";
